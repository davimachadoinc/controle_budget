...
st.set_page_config(page_title="Educacao | Budget", page_icon="💰", layout="wide")
...
st.session_state["_page_key"] = "educacao"
...
if not check_page_password("educacao", "Educacao"):
    st.stop()

render_page("educacao")
