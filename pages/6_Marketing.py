"""pages/6_Marketing.py"""
import streamlit as st

st.set_page_config(page_title="Marketing | Budget", page_icon="💰", layout="wide")
...
st.session_state["_page_key"] = "marketing"
...
if not check_page_password("marketing", "Marketing"):
    st.stop()

render_page("marketing")
