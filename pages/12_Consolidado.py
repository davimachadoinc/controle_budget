"""pages/12_Consolidado.py"""
import streamlit as st

st.set_page_config(page_title="Consolidado | Budget", page_icon="💰", layout="wide")
...
st.session_state["_page_key"] = "consolidado"
...
if not check_page_password("consolidado", "Consolidado"):
    st.stop()

render_page("consolidado")
