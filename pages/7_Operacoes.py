"""pages/10_Operacoes.py"""
import streamlit as st

st.set_page_config(page_title="Operacoes | Budget", page_icon="💰", layout="wide")
...
st.session_state["_page_key"] = "operacoes"
...
if not check_page_password("operacoes", "Operacoes"):
    st.stop()

render_page("operacoes")
