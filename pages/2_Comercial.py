"""pages/5_Comercial.py"""
import streamlit as st

st.set_page_config(page_title="Comercial | Budget", page_icon="💰", layout="wide")
...
st.session_state["_page_key"] = "comercial"
...
if not check_page_password("comercial", "Comercial"):
    st.stop()

render_page("comercial")
