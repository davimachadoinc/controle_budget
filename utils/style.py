"""
utils/style.py
Design system — Premium Brand Dark Mode.
...
h1 {
  ...
  color: var(--text-main) !important; margin-bottom: 4px !important;
...
[data-testid="stMetricValue"] > div {
  ...
  color: var(--accent-1) !important; line-height: 1.15 !important;
}
...
div[data-baseweb="tab-list"] {
  ...
  padding: 5px !important; border: 1px solid var(--border) !important; gap: 4px !important;
}
button[data-baseweb="tab"] {
  background: transparent !important; border-radius: 8px !important;
  color: var(--text-muted) !important; font-weight: 500 !important;
  font-size: 0.88rem !important; padding: 8px 18px !important; transition: all 0.2s ease;
}
...
button[data-baseweb="tab"][aria-selected="true"] {
  ...
  color: var(--accent-1) !important; font-weight: 600 !important;
}
...
div[data-baseweb="select"] > div {
  ...
  color: var(--text-main) !important; transition: border-color 0.2s ease, box-shadow 0.2s ease;
}
